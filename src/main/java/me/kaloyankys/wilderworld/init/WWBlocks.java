...
public class WWBlocks {
    ...
    public static final Block BIRD_OF_PARADISE = register("bird_of_paradise", new TallPlantBlock(AbstractBlock.Settings.create()
            .mapColor(MapColor.ORANGE)
            .nonOpaque()
            .breakInstantly()
            .noCollision()));

    public static final Block CHAMOMILE = register("chamomile", new FlowerBlock(StatusEffects.LUCK, 400, FabricBlockSettings
            .create().mapColor(MapColor.WHITE_GRAY)
            .nonOpaque()
            .breakInstantly()
            .noCollision()));

    public static final Block RAGING_VIOLET = register("raging_violet", new FlowerBlock(StatusEffects.STRENGTH, 400, FabricBlockSettings
            .create().mapColor(MapColor.WHITE_GRAY)
            .nonOpaque()
            .breakInstantly()
            .noCollision()));

    public static final Block GLOWBRUSH = register("glowbrush", new GlowBrushBlock(FabricBlockSettings
            .create().mapColor(MapColor.WHITE_GRAY)
            .nonOpaque()
            .breakInstantly()
            .luminance(state -> {
    ...
    public static final Block SHELFSHROOM = register("shelfshroom", new ShelfshroomBlock(FabricBlockSettings
            .create()
    ...
    public static final Block WISTERIA_BLOSSOM_LEAVES = register("wisteria_blossom_leaves", new LeavesBlock(FabricBlockSettings
    ...
    public static final Block DROOPBLOOM = register("droopbloom", new VerticalConnectorBlock(AbstractBlock.Settings.create().noCollision().breakInstantly().mapColor(DyeColor.MAGENTA).replaceable()));
    ...
    public static final Block ASPEN_LEAVES_AGED = register("aspen_leaves_aged", new LeavesBlock(FabricBlockSettings
            .copy(Blocks.OAK_LEAVES).mapColor(MapColor.ORANGE)
            .nonOpaque()));

    public static final Block ASPEN_LEAVES = register("aspen_leaves", new LeavesBlock(FabricBlockSettings
            .copy(Blocks.OAK_LEAVES).mapColor(MapColor.YELLOW)
            .nonOpaque()));

    public static final Block WISTERIA_LEAVES = register("wisteria_leaves", new LeavesBlock(FabricBlockSettings
            .copy(Blocks.OAK_LEAVES).mapColor(MapColor.YELLOW)
            .nonOpaque()));

    public static final Block BUTTERFLY_SPAWN = register("larvae", new SpawnBlock(FabricBlockSettings
            .create()
            .noCollision()
            .nonOpaque()
            .breakInstantly()));

    public static final Block BUTTERFLY_WING_MEMBRANE_BLOCK = register("butterfly_wing_membrane_block", new Block(FabricBlockSettings
            .create().mapColor(MapColor.ORANGE)));

    public static final Block WAX = register("wax", new WaxBlock(FabricBlockSettings.copy(Blocks.HONEY_BLOCK)));

    public static final Block SCENTED_CANDLE = register("scented_candle", new ScentedCandleBlock(FabricBlockSettings
            .create()
            .luminance((state) -> {
    ...
    public static final Block EBONY_BUSH_TALL = register("ebony_bush_tall", new SnowyBushBlock(FabricBlockSettings.copy(Blocks.GRASS)));
    public static final Block EBONY_BUSH = register("ebony_bush", new SnowyPlantBlock(FabricBlockSettings.copy(Blocks.GRASS)));
    ...
    public static final Block TRAVERTINE = register("travertine", new Block(FabricBlockSettings.copy(Blocks.QUARTZ_BLOCK)));
    public static final Block TRAVERTINE_PEACH = register("travertine_peach", new Block(FabricBlockSettings.copy(Blocks.TERRACOTTA)));
    public static final Block PEARL_STONE = register("pearl_stone", new Block(FabricBlockSettings.copy(Blocks.QUARTZ_BLOCK)));
    public static final Block PEARL_CHISELED = register("pearl_chiseled", new Block(FabricBlockSettings.copy(Blocks.QUARTZ_BLOCK)));
    public static final Block PEARL_TILES = register("pearl_tiles", new Block(FabricBlockSettings.copy(Blocks.QUARTZ_BLOCK)));

    public static final Block COCONUT_FRUIT = register("coconut_fruit", new CoconutFruitBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).ticksRandomly()));
    public static final Block COCONUT = register("coconut", new CoconutBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS)));

    public static final Block PALM_TRUNK = register("palm_trunk", new CoconutBlock(FabricBlockSettings.copy(Blocks.COCOA)));

    public static final Block FROND = register("frond_block", new FrondBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)));
    public static final Block MOSAIC = register("mosaic", new MosaicBlock(FabricBlockSettings.copy(Blocks.CHISELED_BOOKSHELF)));
   ...
   public static RegistrySets.WoodSet registerWoodSet(RegistrySets.WoodSet set, String id, SaplingGenerator saplingGenerator) {
       ...
       Block wood = register(id + "_wood", new PillarBlock(copy(Blocks.OAK_WOOD)));
       Block stairs = register(id + "_stairs", new StairsBlock(Blocks.OAK_STAIRS.getDefaultState(), copy(Blocks.OAK_STAIRS)));
       Block button = register(id + "_button", new ButtonBlock(copy(Blocks.OAK_BUTTON), type, 40, true));
       Block door = register(id + "_door", new DoorBlock(copy(Blocks.OAK_DOOR), type));
       Block fence = register(id + "_fence", new FenceBlock(copy(Blocks.OAK_FENCE)));
       Block gate = register(id + "_fence_gate", new FenceGateBlock(copy(Blocks.OAK_FENCE_GATE), woodType));
       ...
       Block log = register(id + "_log", new PillarBlock(copy(Blocks.OAK_LOG)));
       Block planks = register(id + "_planks", new Block(copy(Blocks.OAK_PLANKS)));
       Block plate = register(id + "_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, copy(Blocks.OAK_PRESSURE_PLATE), type));
       Block strippedWood = register("stripped_" + id + "_wood", new PillarBlock(copy(Blocks.STRIPPED_OAK_WOOD)));
       Block strippedLog = register("stripped_" + id + "_log", new PillarBlock(copy(Blocks.STRIPPED_OAK_LOG)));
       ...
       Block trapDoor = register(id + "_trapdoor", new TrapdoorBlock(copy(Blocks.OAK_TRAPDOOR), type));
       Block slab = register(id + "_slab", new SlabBlock(copy(Blocks.OAK_SLAB)));*/
