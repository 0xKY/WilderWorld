...
public class WWBoatItem extends Item {
    ...
    private final Supplier<EntityType<WWBoatEntity>> boatSupplier;

    public WWBoatItem(Supplier<EntityType<WWBoatEntity>> boatSupplier, Settings settings) {
        super(settings);
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        WWBoatEntity boat = createBoat(world, hit.getPos().x, hit.getPos().y, hit.getPos().z);
    ...
    private WWBoatEntity createBoat(World world, double x, double y, double z) {
        WWBoatEntity entity = boatSupplier.get().create(world);
        if (entity != null) {
            entity.setPos(x, y, z);
