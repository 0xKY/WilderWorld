...
public class WilderworldClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(),
                ...
                //WWBlocks.WISTERIA.POTTED_SAPLING, WWBlocks.WISTERIA.SAPLING,
                WWBlocks.BUTTERFLY_SPAWN,
        ...
        ParticleFactoryRegistry.getInstance().register(WWParticles.CHOCOLATE_DRIP, CustomCustomBlockLeakParticle.ChocolateDripFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.CHOCOLATE_FALL, CustomCustomBlockLeakParticle.ChocolateFallFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.CHOCOLATE_LAND, CustomCustomBlockLeakParticle.ChocolateLandFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.SWEETBERRY_DRIP, CustomCustomBlockLeakParticle.SweetBerryDripFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.SWEETBERRY_FALL, CustomCustomBlockLeakParticle.SweetBerryFallFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.SWEETBERRY_LAND, CustomCustomBlockLeakParticle.SweetBerryLandFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.MINT_DRIP, CustomCustomBlockLeakParticle.MintDripFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.MINT_FALL, CustomCustomBlockLeakParticle.MintFallFactory::new);
        ParticleFactoryRegistry.getInstance().register(WWParticles.MINT_LAND, CustomCustomBlockLeakParticle.MintLandFactory::new);
        ...
        BlockEntityRendererRegistry.register(WWEntities.SINGLE_ITEM_HOLDER, MembraneRenderer::new);
