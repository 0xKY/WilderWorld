...
public class WWPotions {
    ...
    private static Potion registerPotion(String id, StatusEffect statusEffect, Potion potion, PotionRecipe recipe) {
        Registry.register(Registries.STATUS_EFFECT, new Identifier("wilderworld", id), statusEffect);
        Registry.register(Registries.POTION, new Identifier("wilderworld", id), potion);
