...
public class TagUtil {
    ...
    public static ArrayList<Block> blockTagToList(TagKey<Block> tag) {
        ...
        registryEntries.stream().forEach((blockRegistryEntry -> blocks.add(blockRegistryEntry.value())));
        return blocks;
    }
    ...
    public static ArrayList<Item> itemTagToList(TagKey<Item> tag) {
        ...
        registryEntries.stream().forEach((itemRegistryEntry -> blocks.add(itemRegistryEntry.value())));
        return blocks;
    }
}
